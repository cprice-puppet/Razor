...
backends.each do |backend|
  describe "For backend '#{backend}'" do
    describe ProjectRazor::Persist::Controller do
      ...
      describe ".Initialize" do
        it "should create a #{backend_plugin_classes[backend]} object for .database if config persist_mode is #{backend}" do
          @persist.database.class.should == backend_plugin_classes[backend]
        end
